...
public class KYCValidationService {
    ...
    /**
     * Load KYC data from fallback file only (simplified implementation).
     * In production, this would try remote URL first with fallback.
     */
    private KYCDataResult loadKycData() {
        logger.info("Loading KYC data from fallback file (remote service disabled)");
